...
import com.cadebe.petclinic.service.VisitService;
...
@DisplayName("Test VisitController")
@Tag("controller")
class VisitControllerTest {
    ...
    @Test
    @DisplayName("Test init new visit form")
    ...
    @Test
    @DisplayName("Test process new visit form")
